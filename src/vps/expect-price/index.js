...
const priceShowTitle = 'Hiện định giá';
const priceHideTitle = 'Ẩn định giá';

const btnExpectPriceId = 'btn-expect-price'
const btnExpectPriceNode = `
                           <a id=${btnExpectPriceId} class="cursor-point" style="font-size: 12px;
                            padding: 5px; color: white; overflow: hidden; white-space: nowrap;
                             text-overflow: ellipsis; display: block; width: 100px;">
...
const rightMenuExtendNode = `
                    <div id=${rightMenuExtendId} class="v-hide" style="color: rgb(255, 255, 255)">
                        <div class="v-header">
                            Định giá cổ phiếu
                        </div>
                        <div class="v-body">
...
const vpsTopMenuButton = $('#btn-select-lang');
        ...
        let node = `<div class="wrap-stock-record" id="stock-${obj.stock_code}" >
                        ...
                        <div class="stock-record">
                            <div class="stock-code">
                                <a class="cursor-point" id=${obj.stock_code} onclick="showChart('${obj.stock_code}')">
...
$(document).ready(function () {
    ...
    // Add button to menu
    vpsTopMenuButton.after(btnExpectPriceNode);
    // End
