...
let companiesCafef = [];
/**
 * When web is load, emit an action send to "background page" to get "companies information".
 */
...
const rightMenuExtendNode = `
                    <div id=${rightMenuExtendId} class="v-hide">
                        <div class="v-header">
                            Định giá cổ phiếu
                        </div>
                        <div class="v-body">
...
const vndTopRightMenu = $('#menuWrp .buttons');

/**
 * Save data to chrome extension store, this "store" belong to this extension. It's different with Local Storage you see in Chrome Dev Tool
 * Replace all old data and add new
        ...
        let node = `<div class="wrap-stock-record" id="stock-${obj.stock_code}" >
                        ...
                        <div class="stock-record">
                            <div class="stock-code">
                                <a class="cursor-point" id=${obj.stock_code} onclick="openStockDetail('${obj.stock_code}')">
...
$(document).ready(function () {
    ...
    // Add button to menu
    vndTopRightMenu.prepend(btnExpectPriceNode);
    // End
